...
const skills = [{'name':'Ruby on Rails', 'icon':'<i class="fas fa-subway"></i>'},
              ...
              {'name':'Java<br>Spring Boot', 'icon':'<i class="fab fa-java"></i>'},
              {'name':'GitHub<br>GitLab', 'icon':'<i class="fab fa-github"></i>'},
              {'name':'SQLite<br>PostgreSQL<br>MySql<br>h2', 'icon':'<i class="fas fa-database"></i>'},
              {'name':'Web Scraping<br>API<br>JSON<br>Selenium', 'icon':'<i class="fas fa-globe"></i>'},
              {'name':'Angular<br>Typescript<br>Ionic 6', 'icon':'<i class="fab fa-angular"></i>'},
              {'name':'Jira + X-Ray', 'icon':'<i class="fab fa-jira"></i>'},
              {'name':'Intellij<br>VS Code<br>Eclipse', 'icon':'<i class="fas fa-laptop-code"></i>'},
              {'name':'Testautomation<br>UI-Testing<br>Manual Testing<br>API-Testing with Postman', 'icon':'<i class="fas fa-bug"></i>'},
